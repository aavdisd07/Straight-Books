(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const l of t.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function c(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function i(e){if(e.ep)return;e.ep=!0;const t=c(e);fetch(e.href,t)}})();document.addEventListener("DOMContentLoaded",function(){const g=document.getElementById("mobile-menu-button"),s=document.getElementById("mobile-menu");g&&s&&g.addEventListener("click",function(){s.classList.toggle("hidden")}),document.querySelectorAll('a[href^="#"]').forEach(a=>{a.addEventListener("click",function(r){r.preventDefault();const n=document.querySelector(this.getAttribute("href"));n&&(n.scrollIntoView({behavior:"smooth",block:"start"}),s&&!s.classList.contains("hidden")&&s.classList.add("hidden"))})}),document.querySelectorAll(".faq-question").forEach(a=>{a.addEventListener("click",function(){const r=this.nextElementSibling,n=this.querySelector(".faq-icon");r.classList.contains("hidden")?(r.classList.remove("hidden"),n.style.transform="rotate(45deg)"):(r.classList.add("hidden"),n.style.transform="rotate(0deg)")})});const c=document.getElementById("transaction-slider"),i=document.getElementById("employee-slider"),e=document.getElementById("vat-checkbox"),t=document.getElementById("payroll-checkbox"),l=document.getElementById("tax-return-checkbox");function d(){if(!c||!i)return;const a=parseInt(c.value),r=parseInt(i.value),n=(e==null?void 0:e.checked)||!1,m=(t==null?void 0:t.checked)||!1,u=(l==null?void 0:l.checked)||!1;let o=49,x="Starter";a>100&&(o=99,x="Standard"),a>300&&(o=149,x="Premium"),n&&o<99&&(o=99,x="Standard"),m&&r>0&&o<99&&(o=99,x="Standard"),u&&o<149&&(o=149,x="Premium"),document.getElementById("calculated-price").textContent=`£${o}`,document.getElementById("recommended-plan").textContent=x,document.getElementById("transaction-value").textContent=a,document.getElementById("employee-value").textContent=r}c&&c.addEventListener("input",d),i&&i.addEventListener("input",d),e&&e.addEventListener("change",d),t&&t.addEventListener("change",d),l&&l.addEventListener("change",d),d();const p=document.getElementById("contact-form");p&&p.addEventListener("submit",function(a){a.preventDefault(),alert("Thank you for your message! We'll get back to you within 24 hours."),p.reset()})});document.querySelector("#app").innerHTML=`
  <!-- Navigation -->
